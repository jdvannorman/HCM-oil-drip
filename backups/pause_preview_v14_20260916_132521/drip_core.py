...
def analyze(path, output_root=None, config=None, progress=None, cancel=None, pause_gate=None):
    ...
    if config.get('auto_area',False):
        ...
        return analyze_auto(path,output_root,config,progress,cancel,pause_gate)
