...
During a scan, **Pause scan / 暫停** stops further analysis without discarding completed progress. It changes to **Resume scan / 繼續**. **Cancel** ends the run; any already completed video results remain saved.
