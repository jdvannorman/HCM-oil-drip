...
| `events.csv` | Same event list with location-group ID/name, timing-pattern fields, and review decisions, readable in Excel |
| `location_groups.csv` | One row per repeated source-image location, including occurrence count, center point, time range, member IDs, and timing summary |
